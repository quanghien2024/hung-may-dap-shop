...
const mockAccounts = [
  ...
  // --- LIÊN QUÂN MOBILE ---
  { id: 101, code: 'LQ-1029', game: 'lienquan', price: '850,000', numericPrice: 850000, rank: 'Cao Thủ', server: 'Việt Nam', description: 'Acc full tướng, 120 trang phục. Có skin SS tuyệt sắc.', characters: ['Tulen', 'Nakroth', 'Flo'], moreChars: 15, image: 'https://enka.network/ui/UI_Gacha_AvatarImg_Kazuha.png' },
  { id: 102, code: 'LQ-8832', game: 'lienquan', price: '2,500,000', numericPrice: 2500000, rank: 'Thách Đấu', server: 'Việt Nam', description: 'Acc Thách Đấu, skin SSS Violet Huyết Ma Thần. Kèm nhiều hiệu ứng hiếm.', characters: ['Violet', 'Raz', 'Murad'], moreChars: 30, image: 'https://enka.network/ui/UI_Gacha_AvatarImg_Arlecchino.png' },
  { id: 103, code: 'LQ-4421', game: 'lienquan', price: '300,000', numericPrice: 300000, rank: 'Kim Cương', server: 'Việt Nam', description: 'Acc cày smurf, winrate 80%. Đủ ngọc 90 chuẩn.', characters: ['Zuka', 'Ngộ Không'], moreChars: 5, image: 'https://enka.network/ui/UI_Gacha_AvatarImg_Xiao.png' },
  { id: 104, code: 'LQ-9911', game: 'lienquan', price: '1,200,000', numericPrice: 1200000, rank: 'Chiến Tướng', server: 'Việt Nam', description: 'Acc Vip, nhiều trang phục giới hạn sự kiện, collab.', characters: ['Airi', 'Valhein', 'Krixi'], moreChars: 20, image: 'https://enka.network/ui/UI_Gacha_AvatarImg_Nahida.png' },

  // --- FREE FIRE ---
  { id: 201, code: 'FF-5511', game: 'freefire', price: '350,000', numericPrice: 350000, rank: 'Huyền Thoại', server: 'Việt Nam', description: 'Acc có AK Rồng Xanh lv max, súng xịn cực chất.', characters: ['Alok', 'Chrono'], moreChars: 2, image: 'https://enka.network/ui/UI_Gacha_AvatarImg_Neuvillette.png' },
  { id: 202, code: 'FF-9944', game: 'freefire', price: '1,500,000', numericPrice: 1500000, rank: 'Thách Đấu', server: 'Việt Nam', description: 'Acc Vip, full skin súng tiến hóa, MP40 Mãng Xà. Đồ hiếm.', characters: ['Kelly', 'Hayato', 'Wukong'], moreChars: 8, image: 'https://enka.network/ui/UI_Gacha_AvatarImg_Shougun.png' },
  { id: 203, code: 'FF-2211', game: 'freefire', price: '150,000', numericPrice: 150000, rank: 'Kim Cương', server: 'Việt Nam', description: 'Acc giá học sinh, có thẻ vô cực mùa cũ.', characters: ['K'], moreChars: 1, image: 'https://enka.network/ui/UI_Gacha_AvatarImg_Wriothesley.png' },
  { id: 204, code: 'FF-7733', game: 'freefire', price: '800,000', numericPrice: 800000, rank: 'Huyền Thoại', server: 'Việt Nam', description: 'Acc nhiều set đồ collab xịn, hành động cực ngầu.', characters: ['Skyler', 'Moco'], moreChars: 4, image: 'https://enka.network/ui/UI_Gacha_AvatarImg_Hutao.png' }
];
