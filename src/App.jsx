      ...
      <div className={`splash-overlay ${hasEntered ? 'fade-out' : ''}`}>
        ...
        <div className="splash-content animate-fade-in">
          <div className="splash-logo-container">
            <img src="https://media.giphy.com/media/v1.Y2lkPTc5MGI3NjExMGp5Mjc3Y3lPaUpHRGhhSmZqYyZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9cw/jy277cyOiJGDhaJfjc/giphy.gif" alt="Paimon" className="splash-logo-img" />
          </div>
